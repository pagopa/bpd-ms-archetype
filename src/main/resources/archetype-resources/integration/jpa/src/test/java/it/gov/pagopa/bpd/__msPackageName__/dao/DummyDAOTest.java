...
public class DummyDAOTest extends BaseCrudJpaDAOTest<DummyDAO, DummyEntity, java.io.Serializable> {//FIXME: replace with proper dao, entity and id type
    ...
    protected CriteriaQuery<? super DummyEntity> getMatchAlreadySavedCriteria() {
        DummyDAOTest.DummyEntityCriteria pmRuleCriteria = new DummyDAOTest.DummyEntityCriteria();
